...
-- ALLOW INSERT POST EVEN FROM ANON (API WITH ANON KEY - ONLY IN DEVELOPMENT ENVIRONMENT)
...
-- ALLOW INSERT COMMENTS EVEN FROM ANON (API WITH ANON KEY - ONLY IN DEVELOPMENT ENVIRONMENT)
...
-- ALLOW EACH USER TO CREATE THEIR OWN PROFILE (ONLY IN DEVELOPMENT ENVIRONMENT)
...
-- ALLOW EACH USER TO UPDATE THEIR OWN PROFILE (ONLY IN DEVELOPMENT ENVIRONMENT)
